...
def bbox_iou(box1, box2, xywh=True, GIoU=False, EIoU=False, DIoU=False, SIoU=False, CIoU=False,WIoU=False, Focal=False, scale = False, eps=1e-7):
    ...
    if CIoU or DIoU or GIoU or SIoU or WIoU:
        ...
        if CIoU or DIoU or SIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
